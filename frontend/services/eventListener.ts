#!/usr/bin/env ts-node
/**
 * Avalanche Event Listener Background Service
 *
 * Standalone service for monitoring Avalanche C-Chain blockchain events
...
import { getPublicClient } from '../src/lib/rpcClient';
...
const CONFIG = {
  SERVICE_NAME: 'Avalanche Event Listener',
  VERSION: '1.0.0',
...
async function startService() {
  try {
    ...
    console.log(`[Service] ✅ Connected to Avalanche ${chainId === 43113 ? 'Fuji Testnet' : 'C-Chain'} (Chain ID: ${chainId})`);
