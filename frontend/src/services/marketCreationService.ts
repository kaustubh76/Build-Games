...
import { chainsToContracts, crownTokenAbi, CreatorRevenueShareAbi, MicroMarketFactoryAbi, getChainId, getAvalancheRpcUrl, getAvalancheFallbackRpcUrl } from '../constants';
...
const fallbackClient = createPublicClient({
  chain: avalancheFuji,
  transport: http(getAvalancheFallbackRpcUrl(), {
    timeout: RPC_TIMEOUT,
    retryCount: 2,
    retryDelay: 1000,
  }),
