...
// Copy trade config from Avalanche
...
// Agent performance from Avalanche
 ...
 * Calculate copy trading PnL for a user by reading from Avalanche chain and database
 */
  ...
  try {
    ...
    if (followedAgentIds.length === 0) {
      return NextResponse.json({
        ...
        chains: {
          copyTradeData: 'Avalanche Fuji (43113)',
