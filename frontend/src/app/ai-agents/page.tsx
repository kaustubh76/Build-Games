        ...
        {!loading && !error && filteredAgents.length === 0 && (
          <div className="card text-center py-12 md:py-20 animate-fade-in">
            ...
            <p className="text-slate-400 mb-6 text-sm max-w-md mx-auto">
              {agentTypeFilter === 'inft'
                ? 'No iNFT agents found. Create an AI agent to start trading!'
                : agentTypeFilter === 'registry'
          ...
          {[
            {
              ...
              description: 'Create an iNFT agent with custom personality and strategy parameters.',
            },
            {
              step: '2',
              icon: '📊',
              title: 'Agent Trades',
              description: 'Your agent analyzes markets and makes predictions using verified AI compute.',
            },
            {
              step: '3',
              icon: '💰',
