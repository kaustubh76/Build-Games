...
import { useAgentTokenBalance, useMinStakeRequirements, useCRwNBalance } from '@/hooks/useAgents';
...
export default function CreateAgentPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    stakeAmount: '0.01', // Default to minimum (0.01 CRwN for NOVICE tier)
  ...
  // Handler for minting CRwN tokens
                  ...
                  <div className="mt-2 space-y-2">
                    ...
                    {insufficientBalanceError && (
                      <p className="text-xs text-red-400">
                        You need {formData.stakeAmount} CRwN to mint this iNFT.
                      </p>
                    )}
                    {mintCRwNError && (
                      <p className="text-xs text-red-400">
                    ...
                    <p className="text-xs text-gray-600">
                      Min: {requirementsFormatted[0]} CRwN | iNFT staking uses CRwN tokens
                    </p>
                  </div>
                ) : (
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">
                        ...
                        {mintStep === 'uploading' && 'Uploading to Storage...'}
                      ...
                      <p className="text-xs text-gray-400">
                        ...
                        {mintStep === 'uploading' && 'Storing encrypted data on decentralized storage'}
