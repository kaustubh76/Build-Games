      ...
      <div ref={trapRef} className="relative bg-gray-900 border border-gray-700 rounded-xl shadow-2xl w-full max-w-md mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-700">
          <div className="flex items-center gap-3">
            <INFTBadge size="md" />
            <h2 id="transfer-agent-title" className="text-lg font-semibold text-white">Transfer iNFT</h2>
          </div>
          <button
            onClick={handleClose}
            type="button"
        ...
        <div className="px-6 py-4">
            ...
            <>
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 py-3 px-4 bg-gradient-to-r from-red-500 to-blue-500 hover:from-red-600 hover:to-blue-600 text-white rounded-lg font-medium transition-all"
                >
                  Confirm Transfer
                </button>
              </div>
          ...
          {step === 'processing' && (
            <div className="text-center py-8">
              <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-r from-red-500 to-blue-500 flex items-center justify-center animate-pulse">
