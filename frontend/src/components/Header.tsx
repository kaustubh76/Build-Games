...
// Chain type indicator - Avalanche only
...
const NAV_LINKS = [
  ...
  { href: "/arena/replay", label: "Replays", hoverColor: "hover:text-fuchsia-400" },
  ...
  { href: "/portfolio/risk", label: "Risk", hoverColor: "hover:text-fuchsia-400" },
...
const Header: React.FC = () => {
  ...
  const getChainType = useCallback(() => {
    ...
    if (chainId === AVALANCHE_MAINNET_ID) return { type: 'Avalanche', color: 'red', label: 'Mainnet' };
    if (chainId === AVALANCHE_FUJI_ID) return { type: 'Avalanche', color: 'red', label: 'Fuji Testnet' };
