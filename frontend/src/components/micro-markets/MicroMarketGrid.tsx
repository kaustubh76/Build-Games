        ...
        <div className="flex items-center gap-4">
          <button
            ...
            className={`px-3 py-1 text-sm rounded-lg ${
              (viewMode as string) === 'grid' ? 'bg-red-600 text-white' : 'text-gray-400 hover:text-white'
            }`}
          >
            Grid View
          </button>
          <button
            ...
            className={`px-3 py-1 text-sm rounded-lg ${
              (viewMode as string) === 'grouped' ? 'bg-red-600 text-white' : 'text-gray-400 hover:text-white'
            }`}
          >
            Grouped View
          </button>
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-2 flex-wrap">
        <button
          onClick={() => setViewMode('grouped')}
          className={`px-3 py-1 text-sm rounded-lg ${
            viewMode === 'grouped' ? 'bg-red-600 text-white' : 'text-gray-400 hover:text-white'
          }`}
        >
          Grouped View
        </button>
