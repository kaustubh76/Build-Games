...
export function getExplorerUrl(
  ...
  const explorers: Record<number, { name: string; url: string }> = {
    ...
    43113: { name: 'Avalanche Fuji Testnet', url: 'https://testnet.snowtrace.io' },
    43114: { name: 'Avalanche C-Chain', url: 'https://snowtrace.io' },
...
export function isTestnet(chainId: number): boolean {
  const testnets = [43113, 5, 11155111, 80001, 421613];
