...
interface IERC7857 is IERC721 {
     ...
     * @param encryptedMetadataRef Reference to encrypted metadata in decentralized storage (root hash)
    ...
    /**
     * @notice Gets the encrypted metadata reference (storage root hash)
     * @param tokenId Token ID
     * @return Reference string (typically IPFS or storage hash)
     */
