...
# Quick Start Script
#
# One-command deployment for Avalanche implementation
#
# Usage:
...
clear
echo -e "${BOLD}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${BOLD}🚀 Warriors AI - Avalanche Quick Start${NC}"
echo -e "${BOLD}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
...
# Check Market Execute API
if curl -sf http://localhost:3000/api/market/execute > /dev/null 2>&1; then
    echo -e "${GREEN}✓ Market Execute API responding${NC}"
else
    echo -e "${BOLD}⚠ Market Execute API not accessible${NC}"
fi

# Check VRF Trade API
if curl -sf http://localhost:3000/api/market/vrf-trade?mirrorKey=0x0 > /dev/null 2>&1; then
    echo -e "${GREEN}✓ Market VRF Trade API responding${NC}"
else
    echo -e "${BOLD}⚠ Market VRF Trade API not accessible${NC}"
fi
...
echo "   Market Execute: http://localhost:3000/api/market/execute"
echo "   VRF Trade:      http://localhost:3000/api/market/vrf-trade"
echo ""
...
echo ""
echo -e "${GREEN}${BOLD}🎉 Your Avalanche deployment is live!${NC}"
echo ""
