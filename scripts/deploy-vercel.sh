...
#
# Deploys Warriors AI Avalanche frontend to Vercel
#
# Usage:
...
echo ""
echo "1. If env vars are not set, configure them:"
...
echo -e "   ${CYAN}curl https://warriors-ai-rena.vercel.app/api/health${NC}"
echo ""
echo "4. Monitor metrics:"
echo -e "   ${CYAN}curl https://warriors-ai-rena.vercel.app/api/metrics${NC}"
echo ""
