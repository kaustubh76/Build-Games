 ...
 * @notice Deploy the ERC-7857 AI Agent iNFT contracts to Avalanche Fuji Testnet
...
contract DeployAIAgentINFT is Script {
    ...
    function run() external {
        ...
        console2.log("Balance:", deployer.balance / 1e18, "AVAX");
        console2.log("CrownToken:", crownTokenAddr);

        require(block.chainid == CHAIN_ID, "Wrong network! Use Avalanche Fuji RPC");
        ...
        console2.log("================================================");
        console2.log("Chain ID: 43113 (Avalanche Fuji Testnet)");
        console2.log("------------------------------------------------");
        ...
        console2.log("----------------------------------------");
        console2.log("// Add to CONTRACT_ADDRESSES[43113]:");
        console2.log('aiAgentINFT: "', address(aiAgentINFT), '",');
