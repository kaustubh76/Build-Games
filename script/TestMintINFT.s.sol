...
/**
 * @title TestMintINFT
 * @notice Test script for minting an AI Agent iNFT on Avalanche Fuji Testnet
 *
 * Usage:
...
contract TestMintINFT is Script {
    // Deployed contract addresses on Avalanche Fuji Testnet
    // TODO: Update these addresses after deploying to Avalanche
    address constant AI_AGENT_INFT = address(0); // Set after deployment
    address constant CROWN_TOKEN = address(0);   // Set after deployment

    uint256 constant CHAIN_ID = 43113; // Avalanche Fuji Testnet
    ...
    function run() external {
        ...
        console2.log("========================================");
        console2.log("  Test iNFT Minting on Avalanche Fuji");
        console2.log("========================================");
        console2.log("Deployer:", deployer);
        console2.log("Chain ID:", block.chainid);

        require(block.chainid == CHAIN_ID, "Wrong network! Expected Avalanche Fuji (43113)");
        ...
        console2.log("AVAX Balance:", avaxBalance / 1e18, "AVAX");
        ...
        string memory encryptedRef = "ipfs://test-encrypted-metadata-ref-v1";
